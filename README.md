...
| Match First Rival Level        | You can use a patch to make your starter the same level as your rival's for the first battle in the game. Please refer to Game Specific Information section below to learn the exact value |
| Limited Legendaries            | You can pick legendaries under 600 BST in the lab and catch them in the wild before the 1st Gym. Requires unchecking 'Don't use Legendaries' in the Wild Pokemon tab of the Randomizer |
...
| After-lab Boost                | See First: 'Match Coverage Guy' rule. After the lab fight(s) you are allowed to grind up to match first mandatory trainer's ace level before you fight any trainers. After beating the first trainer (either mandatory or optional) you can no longer gain any experience from Wild Pokemon |
### Trainer Pokemon
| Rule                           | Details                                                                                                                                 |
|--------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|
| Additional Trainer Pokemon     | Boss Trainers now have 4 additional Pokemon and Important Trainers - 1 extra Pokemon                                                    |
...
| Catch & Release to Run         | You can use the guarantee to catch a Pokemon with a ball to escape any wild encounter by catching and releasing the wild Pokemon (in case you're not using the Smoke Ball) |
...
| HM Moves in Battle             | You may now use HM moves in battle but only if they are in your Pokemon's learnset. This is possible thanks to randomizer fork's setting. If you choose to delete that HM move you cannot relearn it |
| HM Moves Outside of Battle     | Considering, that you can now have an HM move in your learnset, you are not allowed to use it outside of battle until you acquire a corresponding HM item |
...
| Wild Scouting                  | You are allowed to learn any TM move that would make Wild scouting safe(r), but you are not allowed to use that move in trainer battles.|
...
| Early Smoke Ball               | You can use a patch that gives you a Smoke Ball at the beginning of the game. For example as a held item for your starter               |
### Combat
| Rule                           | Details                                                                                                                                 |
|--------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|
...
Extra Information about the general rules above, but game-specific. The following rule names match the rule names that are present above.
...
| Match First Rival Level        | Level 9              | Due to 72% level increase of Foe Pokemon, Rival's starter will be level 9. To match his level you can use a patch that elevates your starter to level 9 |
